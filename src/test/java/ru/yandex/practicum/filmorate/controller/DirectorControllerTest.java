...
class DirectorControllerTest {
    ...
    @Test
    public void addNormalDirector() throws Exception {
    ...
    @Test
    public void addEmptyNameDirector() throws Exception {
        Director director = Director.builder()
                .id(1)
                .build();
        String json = mapper.writeValueAsString(director);
    ...
    @Test
    public void addBlankNameDirector() throws Exception {
        Director director = Director.builder()
                .id(1)
                .name("")
                .build();
    ...
    @Test
    public void addOnlySpaceContentedNameDirector() throws Exception {
        Director director = Director.builder()
                .id(1)
                .name("   ")
                .build();
    ...
    @Test
    public void getNormalDirector() throws Exception {
        Director director = Director.builder()
                .id(1)
                .name("Name")
                .build();
    ...
    @Test
    public void updateNormalDirector() throws Exception {
        Director director = Director.builder()
                .id(1)
                .name("Name")
                .build();
